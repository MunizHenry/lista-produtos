...
const products = [
    { id: 1, name: "Footbal", price: 49.99, available: true, category: "Sports Goods" },
...
export default function ProductTable() {
    function getRows(): JSX.Element[] {
        ...
        products.forEach(product => {
            //verficar se é necessário adicionar o cabeçalho da categoria 
            if (product.category != lastCategory) {
                rows.push(<ProductCategoryRow key={`cr-${product.id}`} {...product} />);
            }

            //acicionando a linha do produto
